...
function Carousel({
  ...
  return (
    <div className="">
      <div
        style={style}
        className="px-5 flex w-full  box overflow-hidden justify-center py-10 md:py-10  flex-col lg:flex-row "
      >
        <div className="section-right w-full lg:w-1/2   overflow-hidden pl-0 md:pl-20">
          <Swipe
            onSwipeRight={() => {
              addSlide(-1);
              setChange(!change);
        ...
        <div className="mobile-div  hidden mb-4">
          {thumbnails && (
            <div className="thumbnails" style={{ maxWidth: width }}>
              {data.map((item, index) => {
                return (
                  <Image
                    loader={myLoader}
        ...
        <div className="section-left lg:w-1/2 w-full px-0 md:px-10 flex justify-between flex-col">
          ...
          >
            <motion.div variants={stagger} className="inner w-full pr-2">
              ...
              <motion.h1
                className="text-[26px] text-[#333333] w-full xl:w-2/3  font-black leading-[31px]"
                variants={fadeInUp}
              >
                {" "}
                Humming Probe UH1免校正微量酸鹼電極
                <br></br>{" "}
                <p className="text-[18px] text-orange-500 font-bold ">
                  酸鹼試片/酸鹼檢測/pH試片電極/pH電極/pH試片
                </p>
              </motion.h1>
              <motion.p className="dark: text-slate-300 " variants={fadeInUp}>
                <ul className="mt-6 ml-0 pl-0">
                  <li className="text-[16px] dark:text-white font-bold text-black mt-2 w-2/3">
                    {" "}
                    全球首創免校正酸鹼量測的方法，創新技術將電極量測原理整合在單一試片上。採用試片電極檢測pH值，具備以下特色:
                  </li>
                  <li className="text-[16px] font-normal dark:text-white text-black mt-2">
                    {" "}
                    ・即開即用 ，精準免校正
                  </li>
                  <li className="text-[16px] font-normal dark:text-white text-black mt-2">
                  ...
                  <li className="text-m font-normal dark:text-white text-black mt-2">
                    {" "}
                    ・易於攜帶
                  </li>
                </ul>
              ...
              <motion.div variants={fadeInUp} className="btn-row"></motion.div>
            </motion.div>
          </motion.div>
