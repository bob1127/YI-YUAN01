...
function Carousel({
  ...
  return (
    <div className="flex justify-center items-center">
      <div
        style={style}
        className="px-5 flex w-[80%] md:w-full  box overflow-hidden justify-center  py-20  flex-col md:flex-row "
      >
        <div className="section-right  pl-5 md:pl-20">
          <Swipe
            onSwipeRight={() => {
              addSlide(-1);
              setChange(!change);
