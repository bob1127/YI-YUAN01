...
function Carousel({
  ...
  return (
    <div className="flex  justify-center mx-auto items-center">
      <div
        style={style}
        className="px-5 mx-auto flex w-[100%] md:w-full  box overflow-hidden justify-start  py-20 items-start flex-col lg:flex-row "
      >
        <div className="section-right h-auto  w-full lg:w-1/2  pl-5 md:pl-20">
          <Swipe
            onSwipeRight={() => {
              addSlide(-1);
              setChange(!change);
