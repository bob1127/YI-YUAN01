...
function Carousel({
  ...
  return (
    <div className="flex  justify-center mx-auto items-center">
      <div
        style={style}
        className="px-0 md:px-5 mx-auto flex w-[100%] md:w-full  box overflow-hidden justify-start  py-20 items-start flex-col md:flex-row "
      >
        <div className="top-div flex justify-center items-center flex-col">
          <div className="section-right h-auto px-0 overflow-hidden md:px-[20px]  w-full  ">
            <Swipe
              onSwipeRight={() => {
                addSlide(-1);
                setChange(!change);
        ...
        <div className="section-left w-full md:w-1/2 px-0 md:px-10 flex justify-between flex-col">
          ...
          >
            <motion.div variants={stagger} className="inner w-full pr-2">
              ...
              <motion.h1
                className="text-[26px] text-[#333333]  font-black leading-[31px]"
                variants={fadeInUp}
              >
                {" "}
                Humming Probe UX200 免校正酸鹼檢測儀 <br></br>{" "}
                <p className="text-[24px] text-orange-500 font-bold ">
                  pH計/酸鹼度測定計/pH儀器
                </p>
              </motion.h1>
              <motion.p className="dark: text-slate-300 " variants={fadeInUp}>
                <p>適用於全系列全球首創的免校正pH酸鹼電極</p>
