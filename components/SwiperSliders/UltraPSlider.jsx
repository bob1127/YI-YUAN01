    ...
    <section className=" ">
      <div className="container  flex-col lg:flex-row flex  w-full">
        ...
        <div className="right items-start  flex flex-col pt-5 lg:pt-0 justify-between md:pr-[100px] xl:pr-[200px] w-full lg:w-1/2 ">
          <div className="top">
            <h1 className="text-left  w-full mb-5 md:mb-0 md:w-full">
              UltraPeace-Instant H. Pylori Urea Breath Test kit-Pro
            </h1>
            <h2 className="model">UBT-Professional / Home</h2>

            <ul>
              <li>・Non-invasive testing method</li>
              <li>・Obtain results within 30 minutes</li>
              <li>・Assess treatment effect before and after</li>
              <li>・Automatic judgment on the result</li>
              <li>・Two Versions: Professional and Self-Home testing</li>
              {/* <li className="mt-6">
