// pages/project-chengjing5.jsx  或  app/project-chengjing5/page.jsx
"use client";
...
const Project = () => {
  // 原始圖庫（含 .tif），先過濾掉 .tif 以免瀏覽器不支援
  const gallery = [
    "/images/project/宜園誠境/1.webp",
    "/images/project/宜園誠境/2.webp",
    "/images/project/宜園誠境/3.webp",
    "/images/project/宜園誠境/4.webp",
    "/images/project/宜園誠境/5.webp",
    "/images/project/宜園誠境/6.webp",
  ]
    .filter(Boolean)
    .filter((src) => !/\.tif$/i.test(src)); // ← 有轉檔後再加入
  ...
  // 只有在 thumbsSwiper 準備好時才帶入，避免 Object.assign(null) 錯誤
  const thumbsProp =
