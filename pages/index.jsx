    ...
    <Layout>
      ...
      <div className="bg-white">
        ...
        <section className="section_features w-full   mx-auto  mt-[100px]">
          <div className="flex lg:flex-row max-w-[1920px] flex-col-reverse mb-5  w-full mx-auto">
            <div className="img w-1/2">
              <div className="animate-image-wrapper relative w-full aspect-[4/4.2] overflow-hidden">
            ...
            <div className="text w-1/2  flex flex-col  justify-center items-center">
              <div className="flex flex-col  px-0 lg:px-20 justify-start items-start ">
                <div className="title  mx-auto flex flex-col justify-center items-center">
                  ...
                  <h2 className="text-[24px] font-bold">信任 ｜ 宜安心</h2>
          ...
          <section className="lg:py-[50px] max-w-[1920px]  mx-auto">
            <div className="flex lg:flex-row justify-center items-center flex-col w-full sm:w-[95%] mx-auto ">
              <div className="img  w-1/2 flex justify-center items-center p-10  mx-auto sm:mx-3  h-auto lg:h-[60vh] xl:h-[60vh] overflow-hidden">
            ...
            <div className="aspect-[16/6] overflow-hidden relative">
              <div className="txt absolute z-40 left-1/2 top-1/2  -translate-x-1/2 -translate-y-1/2">
                <div className="flex flex-col justify-center items-center max-w-[600px]">
                  <h2 className="text-white text-[45px] font-normal">
                    實在的經典
                  </h2>
          ...
          <section className=" py-[30px]  lg:mt-0 lg:py-[50px] bg-[#6D7B80] sm:py-[70px]">
              ...
              <div className="text mb-5 lg:mb-0 w-[85%]  mx-auto lg:w-[40%]  flex flex-col ">
                <div className="flex flex-col justify-center items-center h-full">
                  <div className="title mx-auto flex flex-col justify-center items-center">
                    ...
                    <p className="leading-loose tracking-widest text-gray-200 mt-8 w-full sm:w-2/3">
                      每個人，都是獨一無二的個體。
                      好的房子，懂得尊重每一種獨特。
            ...
            <div className="flex  max-w-[1920px]  lg:flex-row flex-col-reverse mb-5 mt-20 lg:mt-[10vh] w-[98%] mx-auto">
              <div className="text mb-5 lg:mb-0 w-[85%]  mx-auto lg:w-[40%]  flex flex-col ">
                <div className="flex flex-col justify-center items-center h-full">
                  <div className="title mx-auto flex flex-col justify-center items-center">
                    <p className="text-[43px] text-gray-50">FOEVER</p>
                    <h2 className="text-[24px] font-bold text-gray-50">
                      永恆 ｜ 宜融入
                    </h2>
